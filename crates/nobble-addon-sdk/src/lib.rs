...
pub use addon::{
    ...
    AddonSignal, Availability, Choice, CredentialHandle, Credentials, DeviceAction,
    DeviceKeystroke, FADER_MAX, Invocation, ParamKind, ParamValue, Permission, Reading, Store,
    StoreHandle, Trigger, app_matches,
};
pub use run::run;
